                            ...
                            <!-- <div class="kt-portlet__head-toolbar">
                                <div class="kt-portlet__head-wrapper">
                                    <div class="kt-portlet__head-actions">
                                        <a href="{{ route('so.create') }}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-plus"></i>Add Sales Order</a>
                                    </div>
                                </div>
                            </div> -->
                        </div>
...
@php
if($status_id != '')  {
$datatable_url = route('so.index.status', $status_id);

} else {

$datatable_url = route('so.index');

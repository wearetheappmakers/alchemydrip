			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="{{ route('otherproducttwo.create') }}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-plus"></i>Add</a>
					</div>
				</div>
			</div>
		</div>
...
<script>
	...
	$(document).ready(function() {
		...
		$('#datatable_rows').DataTable({
			...
			ajax: "{{ route('otherproducttwo.index') }}",
